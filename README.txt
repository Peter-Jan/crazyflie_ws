Setting up Ubuntu ROS and Optitrack for Advanced Control System Integration 2018
	-author: Wooshik Kim, TA for ACSI (professor Mark Bedillion)
	-last edit: 10/24/2018 
In this README, we will go through process outlined by Peter Jan, who set up 
crazyflie with optitrack motion capture system. 

We are going to use Ubuntu 14.04 with ROS Indigo for this project. 
Main reason of this configuration is the compatibility of Optitrack code
that we are using from Koushil's lab. It is developed on Ubuntu 14.04 with ROS Indigo. 
(side note: the virtual machine provided from Crazyflie also uses Ubuntu 14.04)
...
2) Setup environment in Ubuntu 14.04
	...
	2-4) Setup Crazyflie from crazyflie_ws folder and install xpad controller
	cd crazyflie_ws  #
